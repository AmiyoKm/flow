        ...
        <div className="flex items-center justify-end space-x-3">
          ...
          <div>
            <h3 className="text-base font-bold text-muted-foreground flex items-center">
              ...
              {isDraft && (
                <Badge className="ml-2 px-2 py-0.5 text-xs font-medium bg-yellow-100 text-yellow-800 rounded-full hover:text-white">
                  Draft
                </Badge>
              )}
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuSeparator />
          <DropdownMenuItem
            className="text-destructive items-center gap-2"
            onSelect={() => {
...
function LastRunDetails({ workflow }: { workflow: Workflow }) {
  ...
  const nextSchedule = nextRunAt && format(nextRunAt , "yyyy-MM-dd:mm")
